...
brew upgrade
```
![assist](http://ww4.sinaimg.cn/large/70dcc3a2gw1e9w52imf93j20ik0czaaz.jpg)
4. 为了使用Moom、EVE等APP，开启辅助功能设置。位于系统偏好设置 - 安全性与隐私 - 隐私 标签页 - 左侧 辅助功能，在左下角点锁图标解锁之后，勾上你要使用的APP。
